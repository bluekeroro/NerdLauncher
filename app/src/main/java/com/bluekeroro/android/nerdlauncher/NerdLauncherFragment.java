package com.bluekeroro.android.nerdlauncher;
...
public class NerdLauncherFragment extends Fragment{
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ActivityHolder(View itemView) {
            super(itemView);
            mNameTextView=(TextView)itemView.findViewById(R.id.text_view_id);
            mIconImageView=(ImageView)itemView.findViewById(R.id.image_view_id);
